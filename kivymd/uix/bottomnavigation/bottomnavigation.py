...
class MDBottomNavigationHeader(ThemableBehavior, ButtonBehavior, MDAnchorLayout):
    ...
    def _update_theme_style(self, instance_theme_manager: ThemeManager, color: list):
...
class MDBottomNavigationItem(MDTab):
    ...
    def on_tab_press(self, *args) -> None:
        ...
        bottom_navigation_header_object = bottom_navigation_object.previous_tab.header
...
class MDBottomNavigation(DeclarativeBehavior, TabbedPanelBase):
    ...
    def switch_tab(self, name_tab) -> None:
        ...
        self.ids.tab_bar.children[numbers_screens.index(count_index_screen)].dispatch(
            "on_press"
        )
    ...
    def on_use_text(self, instance_bottom_navigation, use_text_value: bool) -> None:
    ...
    def on_text_color_normal(self, instance_bottom_navigation, color: list) -> None:
        MDBottomNavigationHeader.text_color_normal = color
        for tab in self.ids.tab_bar.children:
            if not tab.active:
                tab._text_color_normal = color

    def on_text_color_active(self, instance_bottom_navigation, color: list) -> None:
...
class MDBottomNavigationBar(ThemableBehavior, CommonElevationBehavior, MDFloatLayout):
    pass
