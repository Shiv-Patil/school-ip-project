...
class SelectionItem(ThemableBehavior, MDRelativeLayout, TouchBehavior):
    ...
    def set_progress_round(self, interval: Union[int, float]) -> None:
        with self.canvas.after:
            self._instance_progress_inner_circle_color = Color(rgba=(0, 0, 0, 0))
    ...
    def update_progress_inner_circle_ellipse(self, *args) -> None:
        ...
        self._instance_progress_inner_circle_ellipse.pos = self.get_progress_round_pos()
    ...
    def on__progress_animation(self, instance_selection_tem, touch_value: bool) -> None:
        if touch_value:
