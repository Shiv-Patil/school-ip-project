...
with open(os.path.join(uix_path, "spinner", "spinner.kv"), encoding="utf-8") as kv_file:
...
class MDSpinner(ThemableBehavior, Widget):
    ...
    def _on_determinate_progress(self, instance_animation, instance_spinner, value):
        if value == 1:
