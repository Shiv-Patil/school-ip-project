...
with open(os.path.join(uix_path, "menu", "menu.kv"), encoding="utf-8") as kv_file:
        ...
        if self.caller:
            ...
            if self.ver_growth is not None:
                ...
                # ourselves.
                    ...
                    if self._start_coords[1] >= Window.height - self._start_coords[1]:
                        ver_growth = "down"
                        self.target_height = self._start_coords[1] - self.border_margin
            ...
            if self.hor_growth is not None:
                ...
                # ourselves.
                    ...
                    if Window.width - self._start_coords[0] >= self._start_coords[0]:
                        hor_growth = "right"
                        self.target_width = (
                            Window.width - self._start_coords[0] - self.border_margin
                        )
                    # If there's more space to the left.
                        ...
                        hor_growth = "left"
                        self.target_width = self._start_coords[0] - self.border_margin
    ...
    def open(self) -> None:
        ...
        def open(interval):
            ...
            if self.position == "auto":
                ...
                anim = Animation(
                    x=self.tar_x,
                    y=self.tar_y - (self.header_cls.height if self.header_cls else 0),
