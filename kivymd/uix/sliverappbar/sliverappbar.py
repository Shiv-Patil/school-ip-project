...
class MDSliverAppbar(MDBoxLayout, ThemableBehavior):
    ...
    def on_background_color(self, instance_sliver_appbar, color_value: list) -> None:
        if self.toolbar_cls:
    ...
    def on_vbar(self) -> None:
        ...
        percent_min = (1 - self.max_height / scroll_box.height) * 100 + toolbar_percent
        ...
        if self._scroll_was_moving:
            ...
            self.dispatch("on_scroll_content", self.ids.scroll.scroll_y, direction)
        ...
        if self.hide_toolbar:
            if percent_min <= current_percent:
                ...
                self.background_color = self.background_color[0:3] + [1 - opacity]
